            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.php" class="app-brand-link gap-2">
                  <img src="../admin/images/vintique_logo.png" alt="" style="width:170px;height:40px;">
                </a>
              </div>
              <!-- /Logo -->
              ...
              <form id="formAuthentication" class="mb-3" action="" method="post">
                <div class="mb-3">
                  ...
                  <input type="text" name="username" placeholder="Username" autofocus class="form-control form-control-lg">                
                </div>
