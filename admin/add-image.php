...
if (isset($_POST['submit'])) {
  ...
  $folder = "./images/gallery/" . $imgname;
  
  $sql = "INSERT INTO `gallery`(`Image`, `Status`,`Name`,`Detail`)
  VALUES ('$imgname', '$ss','$name','$detail')";
          ...
          >
            <div class="layout-menu-toggle navbar-nav align-items-xl-center me-3 me-xl-0 d-xl-none">
              ...
              <div class="navbar-nav align-items-center">
                <h4 class="card-header fw-bold"><span class="text-muted fw-light">Pages/</span> Gallery</h4>
              </div>
              <!-- /Search -->
          </nav>
          <!-- Content wrapper -->
                      ...
                      <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              ></span>
                              <input
                                name="img"  type="file" class="form-control" id="basic-icon-default-fullname" required/>
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              ></span>
                              <input
                                name="detail"type="text"class="form-control"id="basic-icon-default-fullname"
                                aria-label="John Doe"aria-describedby="basic-icon-default-fullname2"required
                              />
                            </div>
                          </div>
                        ...
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
                            ...
                            <a class="btn btn-link ml-2 w-40 " href="gallery.php">Cancel</a>
                          </div>
                        </div>
                      </form>
                    </div>
