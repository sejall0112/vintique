...
// Check if ID is set and fetch product details
if (isset($_GET['id'])) {
...
if (isset($_POST['update-submit'])) {
    ...
    $detail1 = mysqli_real_escape_string($connect, $_POST['detail1']);
    $detail2 = mysqli_real_escape_string($connect, $_POST['detail2']);
    ...
    if ($product_img) {
        ...
        $sql = "UPDATE product SET Name = '$name', `Detail1` = '$detail1', `Detail2` = '$detail2', Price = '$price', Category_Name = '$category', Image = '$product_img', Status = '$status' WHERE Product_ID = $product_id";
    } else {
        // If no new image is uploaded
        $sql = "UPDATE product SET Name = '$name', Detail1 = '$detail1', Detail2 = '$detail2', Price = '$price', Category_Name = '$category', Status = '$status' WHERE Product_ID = $product_id";
    }

    if (mysqli_query($connect, $sql)) {
        if ($product_img && move_uploaded_file($tmp_img, $move_to)) {
            echo "<script>alert('Product updated successfully');</script>";
        } else {
            echo "<script>alert('Product updated successfully');</script>";
        }
    } else {
        echo "<script>alert('Error updating product: " . mysqli_error($connect) . "');</script>";
    }
}
?>
<!DOCTYPE html>
          ...
          >
            <div class="layout-menu-toggle navbar-nav align-items-xl-center me-3 me-xl-0 d-xl-none">
              ...
              <div class="navbar-nav align-items-center">
                <h4 class="card-header fw-bold"><span class="text-muted fw-light"></span> Edit Product Details</h4>
              </div>
              <!-- /Search -->
          </nav>
          <!-- Content wrapper -->
                    ...
                    <div class="card-body">
                      <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              ...
                              <input
                                name="name"type="text"class="form-control"id="basic-icon-default-fullname"
                               value="<?php echo htmlspecialchars($product['Detail']); ?>"required/>
                            </div>
                          </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                          ...
                          <input
                                name="name"type="text"class="form-control"id="basic-icon-default-fullname"
                               value="<?php echo htmlspecialchars($product['Status']); ?>"required/>
                            </div>
                          </div>
                        </div>
