          ...
          >
            <div class="layout-menu-toggle navbar-nav align-items-xl-center me-3 me-xl-0 d-xl-none">
              ...
              <div class="navbar-nav align-items-center">
                <h4 class="card-header fw-bold"><span class="text-muted fw-light"></span> Category</h4>
              </div>
              <!-- /Search -->
          </nav>
          <!-- Content wrapper -->
              ...
              <div class="card">
                ...
                <div class="card-body">
                          ...
                          ?> 
                            <form action="" method="post" class="mb-3">
                                ...
                                <td><?php echo $data['Category_Status']; ?></td>
                                  <td><a href="edit_category.php?id=<?php echo $data['ID'];?>" class="btn btn-primary">Edit</a>
                  ...
                  <div class="demo-inline-spacing">
                        <button type="button" class="btn btn-outline-warning"><a href="add-category.php">Add Category</a></button>
                      </div>
                </div>
