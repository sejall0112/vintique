...
if(isset($_POST['add-submit'])){
  ...
  $sql = "INSERT INTO `category`(`Category_Name`, `Category_Details_1`, `Category_Details_2`, `Category_Status`) 
  VALUES ('$name','$det1','$det2','$status')";
          ...
          >
            <div class="layout-menu-toggle navbar-nav align-items-xl-center me-3 me-xl-0 d-xl-none">
              ...
              <div class="navbar-nav align-items-center">
                <h4 class="card-header fw-bold"><span class="text-muted fw-light"></span> Add Category Details</h4>
              </div>
              <!-- /Search -->
          </nav>
          <!-- Content wrapper -->
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Detail 2</label>
                          <div class="col-sm-10">
                            <div class="input-group input-group-merge">
                              <span id="basic-icon-default-fullname2" class="input-group-text"
                                ><i class="bx bx-dock-top"></i
                        ...
                        <div class="row justify-content-end">
                          <div class="col-sm-10">
                            ...
                            <a class="btn btn-link ml-2 w-40 " href="category.php">Cancel</a>
                          </div>
                        </div>
                      </form>
                    </div>
